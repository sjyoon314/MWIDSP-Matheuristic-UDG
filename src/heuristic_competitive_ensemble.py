...
def solve_all_ensemble(in_dir_path, instances_subset, out_dir_path):
    out_file_name = f"{instances_subset}_competitive_ensemble_results.csv"
...
if __name__ == '__main__':
    ...
    solve_all_ensemble(args.in_dir_path, args.instances_subset, args.out_dir_path)